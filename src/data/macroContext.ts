// Konteks makro Indonesia 2025–2030 untuk grounding narasi Layer 3 (proyeksi).
// Update terakhir: April 2026. Update per kuartal atau saat ada data
// BPS/BAPPENAS baru yang signifikan.
//
// CATATAN: konten ini diinjeksi ke system prompt edge function
// `generate-projection`. Ia adalah "dapur" untuk AI — bukan untuk dikutip
// verbatim ke siswa.

export const INDONESIA_MACRO_CONTEXT = `
