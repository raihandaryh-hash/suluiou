...
export const evanInsights = {
  ...
  tamparanSection: {
    title: 'Empat Tamparan dari Pemberi Kerja',
    subtitle: 'Bukan cerita buruk — ini sinyal yang perlu dibaca lebih awal.',
    items: [
      {
        label: 'Skills-Based Hiring',
        desc: 'Perusahaan tidak lagi merekrut berdasarkan nama kampus. Yang dicari: bisa langsung bekerja, ada bukti nyata, tidak butuh training panjang.',
      },
      {
        label: 'Hit the Ground Running',
        desc: 'Tidak ada lagi budget orientasi panjang. Hari pertama sudah harus berkontribusi — siap, atau digantikan.',
      },
      {
        label: 'Saringan Makin Sempit',
        desc: '100 pelamar → 1–2 yang lolos. Program management trainee dan posisi junior jauh lebih sedikit dari satu dekade lalu.',
      },
      {
        label: 'Gig Economy',
        desc: '57% pekerja Indonesia di sektor informal. Bagi yang punya skill dan kemandirian: kebebasan. Bagi yang tidak: jurang.',
      },
    ],
  },
  kisahSection: {
    title: 'Ini Bukan Statistik — Ini Manusia',
    items: [
      {
        name: 'Putri, 22 tahun',
        story: '80 lamaran, nol panggilan. Fresh graduate Undip yang melamar ke seluruh Indonesia. Di satu job fair: 6.654 lowongan — tapi diserbu puluhan ribu pelamar.',
        source: 'Kompas / Tribun Jateng, Agustus 2025',
      },
      {
        name: 'Fardi',
        story: 'Menyesal tidak pernah magang. Puluhan lamaran, hanya 3–4 interview, 2 tahun menganggur.',
        source: 'Mojok, September 2025',
      },
    ],
    neetNote: 'Mereka bukan pengecualian. Hampir 9 juta anak muda Indonesia saat ini berstatus NEET — tidak bekerja, tidak sekolah, tidak dalam pelatihan apapun.',
    neetSource: 'BPS Sakernas Agustus 2025',
  },
  pilarSection: {
    title: 'Dua Pilar yang Membuat Kamu Survive',
    quote: '"Gen Alpha jagoan memakai AI — tapi membeku ketika harus berbicara langsung dengan atasannya. Teknologi melimpah; kematangan manusia justru menjadi langka."',
    wefNote: '63% pemberi kerja menyebut kesenjangan keterampilan sebagai penghalang utama transformasi bisnis.',
    wefSource: 'WEF Future of Jobs 2025',
    items: [
      {
        label: 'Kemandirian & Resilience',
        points: [
          'Belajar hal baru tanpa harus diawasi',
          'Menyelesaikan masalah — tidak menyerah saat terhambat',
          'Produktif tanpa bergantung motivasi eksternal',
        ],
      },
      {
        ...
        points: [
          ...
          'Menepati komitmen — bukan sekadar berjanji',
          'Mengelola emosi dan konflik secara matang',
        ],
      },
    ],
  },
  ekosistemSection: {
    ...
    items: [
      {
        num: '1',
        label: 'Fondasi Spiritual',
        desc: 'Tauhid dan niat yang benar. Self-leadership dimulai dari kedekatan dengan Allah — dunia sebagai ladang, bukan tujuan.',
      },
      {
        num: '2',
        label: 'Kapasitas Diri',
        desc: 'Ilmu, skill, dan kemandirian. Padukan fardhu ain dengan keahlian masa depan — resilien, adaptif, mampu belajar mandiri.',
      },
      {
        num: '3',
        label: 'Relasi & Komunitas',
        desc: 'Barisan dan kolaborasi. Allah membedakan potensi tiap orang agar saling melengkapi — bangun jaringan yang kokoh.',
      },
      {
        num: '4',
        label: 'Lingkungan Bertumbuh',
        desc: 'Pendidikan adaptif dan aksi nyata. Pilih wadah yang melatih kemandirian dan menuntut karya nyata.',
      },
    ],
    projection: {
      text: 'Proyeksi: 24% tingkat pengangguran global pada 2050 — jika sistem dan manusia tidak beradaptasi.',
      source: 'The Millennium Project (lembaga foresight independen, konsensus pakar global/Delphi)',
    },
  },
  footer: {
    ayat: {
